...
context("Grid Row Form Tabs", () => {
	...
	it("should display tabs in grid row form", () => {
		...
		cy.get('.dontmanage-control[data-fieldname="items"]').as("table");
	...
	it("should switch tabs in grid row form", () => {
		...
		cy.get("@table-form")
			.find('.dontmanage-control[data-fieldname="item_name"]')
			.should("be.visible");
		cy.get("@table-form")
			.find('.dontmanage-control[data-fieldname="quantity"]')
			.should("be.visible");
		...
		cy.get("@table-form")
			.find('.dontmanage-control[data-fieldname="description"]')
			.should("be.visible");
		cy.get("@table-form").find('.dontmanage-control[data-fieldname="notes"]').should("be.visible");
	});
	...
	it("should allow data entry in fields across different tabs", () => {
		...
		cy.get("@table-form")
			...
			.should("have.class", "active");
		cy.get("@table-form")
			.find('.dontmanage-control[data-fieldname="item_name"] input')

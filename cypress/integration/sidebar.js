...
context("Sidebar", () => {
	before(() => {
		...
		return cy
			...
			.its("dontmanage")
			.then((dontmanage) => {
				return dontmanage.call("dontmanage.tests.ui_test_helpers.create_doctype_for_attachment");
			});
	});

	it("Verify attachment visibility config", () => {
		cy.call("dontmanage.tests.ui_test_helpers.create_todo", {
	...
	it("Verify attachment accessibility UX", () => {
		cy.call("dontmanage.tests.ui_test_helpers.create_todo_with_attachment_limit", {

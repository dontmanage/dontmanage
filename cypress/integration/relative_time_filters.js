...
// 		cy.window().its('dontmanage').then(dontmanage => {
// 			dontmanage.call("dontmanage.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/dontmanage.model.utils.user_settings.save')

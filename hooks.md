...
1. `app_name` - slugified name e.g. "dontmanage"
1. `app_title` - full title name e.g. "DontManage"
1. `app_publisher`
1. `app_description`
1. `app_version`
...
1. `app_include_css` - assets/dontmanage/css/splash.css

1. `web_include_js` - assets/js/dontmanage-web.min.js
1. `web_include_css` - assets/css/dontmanage-web.css

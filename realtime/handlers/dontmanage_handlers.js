const { dontmanage_request } = require("../utils");
const log = console.log;

const WEBSITE_ROOM = "website";
const SITE_ROOM = "all";

function dontmanage_handlers(realtime, socket) {
...
function can_subscribe_doctype(args) {
	...
	dontmanage_request("/api/method/dontmanage.realtime.can_subscribe_doctype", args.socket)
		.type("form")
		.query({
...
function can_subscribe_doc(args) {
	...
	dontmanage_request("/api/method/dontmanage.realtime.can_subscribe_doc", args.socket)
		.type("form")
		.query({
			doctype: args.doctype,
			docname: args.docname,
...
module.exports = dontmanage_handlers;

...
function authenticate_with_dontmanage(socket, next) {
	...
	socket.dontmanage_request = (path, args = {}, opts = {}) => {
	...
	socket
		.dontmanage_request("/api/method/dontmanage.realtime.get_user_info")
		.then((res) => res.json())
		.then(({ message }) => {
...
module.exports = authenticate_with_dontmanage;

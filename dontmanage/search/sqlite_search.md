...
```python
# my_app/search.py
from dontmanage.search.sqlite_search import SQLiteSearch
...
class MyAppSearch(SQLiteSearch):
    ...
    def get_search_filters(self):
        ...
        accessible_projects = dontmanage.get_all(
            "Project",
...
def build_index_in_background():
    ...
    if search.is_search_enabled() and not search.index_exists():
        dontmanage.enqueue("my_app.search.build_index", queue="long")

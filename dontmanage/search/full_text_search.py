...
class FullTextSearch:
	...
	def create_index(self):
		dontmanage.create_folder(self.index_path)
	...
	def search(self, text: str, scope: str | None = None, limit: int = 20) -> list[dontmanage._dict]:
...
def get_index_path(index_name):
	return dontmanage.get_site_path("indexes", index_name)

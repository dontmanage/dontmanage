...
def get_context(context):
	context.javascript = dontmanage.db.get_single_value("Website Script", "javascript") or ""
...
def get_setting(field_name):
	...
	website_settings = dontmanage.db.get_single_value("Website Settings", field_name)

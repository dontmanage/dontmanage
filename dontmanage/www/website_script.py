...
def get_context(context):
	should_cache = not_modified_recently(dontmanage.get_website_settings("modified"))

	website_script = dontmanage.get_cached_doc("Website Script")
...
def get_setting(field_name):
	...
	website_settings = dontmanage.get_website_settings(field_name)
	conf = dontmanage.conf.get(field_name)

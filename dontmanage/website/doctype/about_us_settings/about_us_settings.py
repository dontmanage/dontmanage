...
class AboutUsSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from dontmanage.website.doctype.about_us_team_member.about_us_team_member import AboutUsTeamMember
		from dontmanage.website.doctype.company_history.company_history import CompanyHistory

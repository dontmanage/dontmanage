...
# test_records = dontmanage.get_test_records('Help Article')


class TestHelpArticle(DontManageTestCase):
	@classmethod
	def setUpClass(cls) -> None:
		cls.help_category = dontmanage.get_doc(
			{
		...
		cls.help_article = dontmanage.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from dontmanage.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		dontmanage.delete_doc(cls.help_article.doctype, cls.help_article.name)
		dontmanage.delete_doc(cls.help_category.doctype, cls.help_category.name)

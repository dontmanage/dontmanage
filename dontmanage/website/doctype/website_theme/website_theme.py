...
class WebsiteTheme(Document):
	...
	def is_standard_and_not_valid_user(self):
		return (
			...
			and not (dontmanage.flags.in_import or dontmanage.in_test or dontmanage.flags.in_migrate)
		)
...
def get_active_theme() -> "WebsiteTheme" | None:
	if website_theme := dontmanage.get_website_settings("website_theme"):
		try:
			return dontmanage.client_cache.get_doc("Website Theme", website_theme)

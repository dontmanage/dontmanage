...
class WebsiteSettings(Document):
	...
	def validate_google_settings(self):
		if self.enable_google_indexing and not dontmanage.db.get_single_value("Google Settings", "enable"):
...
def get_website_settings(context=None):
	...
	settings: "WebsiteSettings" = dontmanage.get_cached_doc("Website Settings")

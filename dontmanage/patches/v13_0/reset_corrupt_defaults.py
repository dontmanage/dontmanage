import dontmanage
from dontmanage.patches.v13_0.encrypt_2fa_secrets import DOCTYPE
from dontmanage.patches.v13_0.encrypt_2fa_secrets import PARENT_FOR_DEFAULTS as TWOFACTOR_PARENT
...
def execute():
	...
	# letter head
	try:
		letter_head = dontmanage.get_doc("Letter Head", {"is_default": 1})

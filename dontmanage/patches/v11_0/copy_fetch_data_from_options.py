...
def execute():
	dontmanage.reload_doc("core", "doctype", "docfield", force=True)
	dontmanage.reload_doc("custom", "doctype", "custom_field", force=True)
	dontmanage.reload_doc("custom", "doctype", "customize_form_field", force=True)
	dontmanage.reload_doc("custom", "doctype", "property_setter", force=True)

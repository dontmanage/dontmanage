...
import dontmanage
from dontmanage import safe_decode
from dontmanage.core.doctype.communication.communication import Communication
from dontmanage.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from dontmanage.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from dontmanage.email.receive import Email, InboundMail
...
<div>
	...
	<img embed="assets/dontmanage/images/dontmanage-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/dontmanage/images/dontmanage-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = dontmanage.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="dontmanage-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/dontmanage/images/dontmanage-favicon.svg" alt="test" />
...
From: test1_@dontmanageerp.com
Reply-To: test2_@dontmanageerp.com
"""
			+ text_content_bytes
		)
...
"""
		...
		# https://github.com/dontmanage/dontmanage/pull/3371
		# self.assertEqual(mail.from_real_name, '"fail@example.com" via DEF')

		email_account = dontmanage._dict({"email_id": "receive@example.com"})

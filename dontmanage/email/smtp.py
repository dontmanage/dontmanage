...
def send(email, append_to=None, retry=1):
	...
	def _send(retry):
		...
		try:
			...
			dontmanage.throw(_("Invalid login or password"), title="Email Failed")
			raise
		except smtplib.SMTPRecipientsRefused:
			dontmanage.msgprint(_("Invalid recipient address"), title="Email Failed")
			raise
...
class SMTPServer:
	...
	def session(self):
		...
		try:
			...
			dontmanage.throw(_("Invalid Outgoing Mail Server or Port"), title=_("Incorrect Configuration"))

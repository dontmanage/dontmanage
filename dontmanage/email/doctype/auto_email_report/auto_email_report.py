...
class AutoEmailReport(Document):
	...
	def validate_report_count(self):
		...
		max_reports_per_user = (
			...
			or cint(dontmanage.db.get_single_value("System Settings", "max_auto_email_report_per_user"))
			or 20
		)
	...
	for row in data:
		...
		for col in columns:
			...
			if col.fieldtype == "Link":
				...
				doc = dontmanage.get_doc(col.parent, doc_name) if doc_name and col.get("parent") else None

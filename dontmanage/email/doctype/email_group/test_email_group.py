...
from dontmanage.utils import validate_url

# test_records = dontmanage.get_test_records('Email Group')


class TestEmailGroup(DontManageTestCase):
	def test_welcome_url(self):
		email_group = dontmanage.new_doc("Email Group")

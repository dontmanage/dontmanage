...
import dontmanage
import dontmanage.desk.form.document_follow as document_follow
from dontmanage.desk.form.assign_to import add
from dontmanage.desk.form.document_follow import get_document_followed_by_user
...
from dontmanage.share import add as share
from dontmanage.tests.utils import DontManageTestCase


class TestDocumentFollow(DontManageTestCase):
	...
	def tearDown(self):
		...
		dontmanage.db.delete("Document Follow")
	...
	doc = dontmanage.get_doc(
		{
			...
			"doc.starts_on": dontmanage.utils.now(),
			"doc.ends_on": dontmanage.utils.add_days(dontmanage.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if dontmanage.db.exists("User", "test@docsub.com"):
		doc = dontmanage.delete_doc("User", "test@docsub.com")
	doc = dontmanage.new_doc("User")
...
def get_emails(event_doc, search_string):
	...
	return (
		dontmanage.qb.from_(EmailQueue)

...
test_records = dontmanage.get_test_records("Email Domain")


class TestDomain(DontManageTestCase):
	def setUp(self):
		make_test_objects("Email Domain", reset=True)

	def tearDown(self):
		dontmanage.delete_doc("Email Account", "Test")
		dontmanage.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = dontmanage.get_doc("Email Domain", "test.com")
		mail_account = dontmanage.get_doc("Email Account", "Test")

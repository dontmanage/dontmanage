...
class TestEmailAccount(IntegrationTestCase):
	...
	def test_sendmail(self):
		...
		dontmanage.db.commit()  # now=True requires commit
	...
	def test_threading_by_message_id(self):
		...
		event = dontmanage.get_doc(doctype="Event", subject="test-message").insert()
	...
	def test_handle_bad_encoding(self):
		...
		self.assertTrue(dontmanage.db.get_value("Unhandled Email", {"uid": uid}))

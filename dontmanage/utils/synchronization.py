...
from dontmanage.utils import get_bench_path, get_site_path
from dontmanage.utils.file_lock import LockTimeoutError
...
def filelock(lock_name: str, *, timeout=30, is_global=False):
	...
	try:
		...
		dontmanage.log_error(f"Filelock: Failed to aquire {lock_path}")

...
Use `dontmanage.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import dontmanage
from dontmanage.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in dontmanage.local.locked_documents:
		doc.unlock()

...
class UserPermissions:
	...
	def build_perm_map(self):
		...
		for r in get_valid_perms():
			...
			for k in dontmanage.permissions.rights:
...
def get_fullname_and_avatar(user: str) -> _dict:
	first_name, last_name, avatar, name = dontmanage.db.get_value(
...
def is_website_user(username: str | None = None) -> str | None:
	return dontmanage.db.get_value("User", username or dontmanage.session.user, "user_type") == "Website User"

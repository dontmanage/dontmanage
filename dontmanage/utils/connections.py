...
from dontmanage import get_conf
from dontmanage.exceptions import UrlSchemeNotSupported
...
def check_database():
	...
	if db_type == "sqlite":
		db_path = Path(dontmanage.utils.get_site_path()) / "db" / f"{config.db_name}.db"

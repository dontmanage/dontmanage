...
def after_install():
	...
	if not dontmanage.conf.skip_setup_wizard:
		...
		if not dontmanage.db.get_default("desktop:home_page"):
			...
			dontmanage.db.set_single_value("System Settings", "setup_complete", 0)
...
def get_admin_password():
	...
	admin_password = dontmanage.conf.get("admin_password")
...
def before_tests():
	...
	if not int(dontmanage.db.get_single_value("System Settings", "setup_complete") or 0):
...
def add_standard_navbar_items():
	...
	standard_navbar_items = [
		...
		},
		{
			...
			"item_type": "Action",
			"action": "dontmanage.ui.toolbar.view_website()",
			"is_standard": 1,
		},
		{

...
after_app_install = "dontmanage.utils.install.auto_generate_icons_and_sidebar"
after_app_uninstall = "dontmanage.utils.install.delete_desktop_icon_and_sidebar"
...
app_include_icons = [
	"/assets/dontmanage/icons/lucide/icons.svg",
	"/assets/dontmanage/icons/timeless/icons.svg",
	"/assets/dontmanage/icons/espresso/icons.svg",
	"/assets/dontmanage/icons/desktop_icons/alphabets.svg",
]
...
on_login = "dontmanage.desk.doctype.note.note._get_unseen_notes"
...
pdf_generator = "dontmanage.utils.pdf.get_chrome_pdf"
# permissions
...
permission_query_conditions = {
	...
	"User Invitation": "dontmanage.core.doctype.user_invitation.user_invitation.get_permission_query_conditions",
}
...
has_permission = {
	...
	"User Invitation": "dontmanage.core.doctype.user_invitation.user_invitation.has_permission",
}
...
doc_events = {
	"*": {
		"on_update": [
			...
			"dontmanage.core.doctype.permission_log.permission_log.make_perm_log",
			"dontmanage.search.sqlite_search.update_doc_index",
		],
		...
		"on_trash": [
			"dontmanage.desk.notifications.clear_doctype_notifications",
			"dontmanage.workflow.doctype.workflow_action.workflow_action.process_workflow_actions",
			"dontmanage.search.sqlite_search.delete_doc_index",
		],
		...
		"after_delete": ["dontmanage.core.doctype.permission_log.permission_log.make_perm_log"],
	},
	"Event": {
	...
	"DocType": {
		"on_update": "dontmanage.cache_manager.build_domain_restricted_doctype_cache",
	},
	"Page": {
		"on_update": "dontmanage.cache_manager.build_domain_restricted_page_cache",
	},
}
...
scheduler_events = {
	"cron": {
		# 5 minutes
		"0/5 * * * *": [
			"dontmanage.email.doctype.notification.notification.trigger_offset_alerts",
		],
		# 15 minutes
		"0/15 * * * *": [
			...
			"dontmanage.search.sqlite_search.build_index_if_not_exists",
			"dontmanage.utils.telemetry.pulse.client.send_queued_events",
		],
		# 10 minutes
		"0/10 * * * *": [
	...
	"all": [
		...
		"dontmanage.email.queue.retry_sending_emails",
	...
	"hourly_maintenance": [
		...
		"dontmanage.desk.utils.delete_old_exported_report_files",
	],
	"daily": [
	...
	"daily_maintenance": [
		...
		"dontmanage.core.doctype.user_invitation.user_invitation.mark_expired_invitations",
	],
	"weekly_long": [
		"dontmanage.desk.form.document_follow.send_weekly_updates",
		"dontmanage.utils.change_log.check_for_update",
		"dontmanage.desk.doctype.changelog_feed.changelog_feed.fetch_changelog_feed",
	],
	"monthly": [
...
after_migrate = [
	"dontmanage.website.doctype.website_theme.website_theme.after_migrate",
	"dontmanage.search.sqlite_search.build_index_in_background",
]
...
override_whitelisted_methods = {
	# Legacy File APIs
	"dontmanage.utils.file_manager.download_file": "download_file",
...
before_request = [
	...
	"dontmanage.integrations.oauth2.set_cors_for_privileged_requests",
]
...
get_changelog_feed = "dontmanage.desk.doctype.changelog_feed.changelog_feed.get_feed"
...
standard_navbar_items = [
	{
		...
		"item_type": "Action",
		"action": "dontmanage.ui.toolbar.route_to_user()",
		"is_standard": 1,
	},
	{
		"item_label": "Log out",
		"item_type": "Action",
		"action": "dontmanage.app.logout()",
		"is_standard": 1,
	},
]
...
standard_help_items = [
	{
		"item_label": "About",
		"item_type": "Action",
		"action": "dontmanage.ui.toolbar.show_about()",
		"is_standard": 1,
	},
	{
		"item_label": "Keyboard Shortcuts",
		"item_type": "Action",
		"action": "dontmanage.ui.toolbar.show_shortcuts(event)",
		"is_standard": 1,
	},
	{
	...
	{
		"item_label": "DontManage Support",
		"item_type": "Route",
		"route": "https://dontmanage.io/support",
		"is_standard": 1,
	},
]
...
# These keys will not be erased when doing dontmanage.clear_cache()

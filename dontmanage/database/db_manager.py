...
class DbManager:
	def __init__(self, db: dontmanage.database.database.Database | None = None):
		"""
	...
	def restore_database(verbose: bool, target: str, source: str, user: str, password: str) -> None:
		...
		from dontmanage.utils import execute_in_shell

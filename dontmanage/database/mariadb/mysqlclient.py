...
from dontmanage.utils import get_datetime, get_table_name
...
def escape_frozenset(obj, mapping=None):
	return dontmanage.local.db._conn.literal(tuple(obj))
...
class MariaDBDatabase(MariaDBConnectionUtil, MariaDBExceptionUtil, Database):
	...
	def escape(s, percent=True):
		...
		s = dontmanage.as_unicode(escape_string(s)).replace("`", "\\`") if s else ""

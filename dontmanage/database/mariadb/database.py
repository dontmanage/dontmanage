...
class MariaDBConnectionUtil:
	...
	def get_connection_settings(self) -> dict:
		...
		if self.user not in (dontmanage.flags.root_login, "root"):
		...
		if dontmanage.conf.db_ssl_ca and dontmanage.conf.db_ssl_cert and dontmanage.conf.db_ssl_key:
			conn_settings["ssl"] = {
				"ca": dontmanage.conf.db_ssl_ca,
				"cert": dontmanage.conf.db_ssl_cert,
				"key": dontmanage.conf.db_ssl_key,
			}

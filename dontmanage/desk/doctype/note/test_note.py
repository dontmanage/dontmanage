...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		dontmanage.db.delete("Version")
		dontmanage.db.delete("Note")
		dontmanage.db.delete("Note Seen By")

		return dontmanage.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = dontmanage.get_doc("Version", dict(docname=note.name))

...
def get_config(name: str) -> str:
	doc: DashboardChartSource = dontmanage.get_doc("Dashboard Chart Source", name)
...
class DashboardChartSource(Document):
	...
	def on_trash(self):
		...
		dontmanage.db.after_commit.add(self.delete_folder)
	...
	def get_folder_path(self) -> Path:
		...
		return Path(get_module_path(self.module)) / FOLDER_NAME / dontmanage.scrub(self.name)

...
dontmanage.ui.form.on("Global Search Settings", {
	refresh: function (frm) {
		dontmanage.realtime.on("global_search_settings", (data) => {
			if (data.progress) {
		...
		frm.add_custom_button(__("Reset"), function () {
			dontmanage.call({
				method: "dontmanage.desk.doctype.global_search_settings.global_search_settings.reset_global_search_settings_doctypes",
				callback: function () {

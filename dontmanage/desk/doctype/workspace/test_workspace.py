...
class TestWorkspace(DontManageTestCase):
	def setUp(self):
		create_module("Test Module")

	def tearDown(self):
		dontmanage.db.delete("Workspace", {"module": "Test Module"})
		dontmanage.db.delete("DocType", {"module": "Test Module"})
		dontmanage.delete_doc("Module Def", "Test Module")
	...
	# 	if dontmanage.get_system_settings('country') == "France":
...
def create_workspace(**args):
	workspace = dontmanage.new_doc("Workspace")

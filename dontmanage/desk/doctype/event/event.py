...
class Event(Document):
	...
	def on_trash(self):
		...
		if communications:
			for communication in communications:
				dontmanage.delete_doc_if_exists("Communication", communication.name)
	...
	def update_communication(self, participant, communication):
		...
		communication.sender_full_name = dontmanage.utils.get_fullname(self.owner)
		communication.reference_doctype = self.doctype
		communication.reference_name = self.name
...
def delete_communication(event, reference_doctype, reference_docname):
	...
	comms = dontmanage.get_list("Communication", filters=filters, fields=["name"])

	if comms:
		deletion = []
		for comm in comms:
			delete = dontmanage.get_doc("Communication", comm.name).delete()

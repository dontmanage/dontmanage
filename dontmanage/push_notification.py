...
class PushNotification:
	...
	def _get_credential(self) -> tuple[str, str]:
		...
		body = {
			...
			"token": token,
			"webhook_route": "/api/method/dontmanage.push_notification.auth_webhook",
		}
...
def auth_webhook():
	url = urlparse(dontmanage.utils.get_url()).hostname
	token = dontmanage.cache().get_value(f"{url}:push_relay_registration_token")
	response = Response()

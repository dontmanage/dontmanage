...
from dontmanage.utils import cast, cint, cstr
...
def get_field_precision(df, doc=None, currency=None):
	...
	from dontmanage.utils import get_number_format_info
	...
	if df.precision:
		...
		if not precision:
			number_format = dontmanage.db.get_default("number_format") or "#,###.##"

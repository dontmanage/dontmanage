...
from dontmanage.social.doctype.energy_point_log.energy_point_log import create_review_points_log
from dontmanage.utils import add_to_date, getdate, today
...
def is_energy_point_enabled():
	return dontmanage.db.get_single_value("Energy Point Settings", "enabled", True)

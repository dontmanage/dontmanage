...
def download_dontmanage_assets(verbose=True):
	"""Downloads and sets up DontManage assets if they exist based on the current
	commit HEAD.
...
def html_to_js_template(path, content):
	"""returns HTML template content as Javascript code, adding it to `dontmanage.templates`"""

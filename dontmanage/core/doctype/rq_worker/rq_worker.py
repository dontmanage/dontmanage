...
from dontmanage.utils import cint, convert_utc_to_system_timezone
from dontmanage.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> dontmanage._dict:
	...
	if current_job and not current_job.startswith(dontmanage.local.site):
		current_job = None

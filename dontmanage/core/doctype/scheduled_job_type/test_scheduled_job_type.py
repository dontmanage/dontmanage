...
class TestScheduledJobType(DontManageTestCase):
	...
	def test_sync_jobs(self):
		...
		daily_job = dontmanage.get_doc(
			"Scheduled Job Type", dict(method="dontmanage.email.queue.set_expiry_for_email_queue")
		)
		...
		updated_scheduled_job = dontmanage.get_doc(
			"Scheduled Job Type", {"method": "dontmanage.email.queue.flush"}
		)

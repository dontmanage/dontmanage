...
def get_preview_from_template(data_import, import_file=None, google_sheets_url=None):
	return dontmanage.get_doc("Data Import", data_import).get_preview_from_template(
...
def form_start_import(data_import):
	return dontmanage.get_doc("Data Import", data_import).start_import()
...
def get_import_status(data_import_name):
	...
	total_payload_count = dontmanage.db.get_value("Data Import", data_import_name, "payload_count")

...
class File(Document):
	...
	def before_insert(self):
		...
		if self.is_remote_file:
			...
			dontmanage.local.rollback_observers.append(self)
	...
	def create_attachment_record(self):
		...
		file_url = quote(dontmanage.safe_encode(self.file_url)) if self.file_url else self.file_name
...
def has_permission(doc, ptype=None, user=None):
	...
	if ptype == "create":
		has_access = dontmanage.has_permission("File", "create", user=user)

...
# this is a separate file since it is imported in dontmanage.model.document
...
def run_server_script_for_doc_event(doc, event):
	...
	if scripts:
		...
		for script_name in scripts:
			dontmanage.get_cached_doc("Server Script", script_name).execute_doc(doc)
...
def get_server_script_map():
	...
	script_map = dontmanage.client_cache.get_value("server_script_map")
	if script_map is None:
		...
		dontmanage.client_cache.set_value("server_script_map", script_map)

...
dontmanage.query_reports["Database Storage Usage By Tables"] = {
	filters: [],
			...
			function () {
				let d = new dontmanage.ui.Dialog({
					...
					primary_action(values) {
						dontmanage.call({
							method: "dontmanage.core.report.database_storage_usage_by_tables.database_storage_usage_by_tables.optimize_doctype",
							args: {

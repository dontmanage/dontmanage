...
from dontmanage.utils import get_datetime, get_url, now_datetime
...
def process_workflow_actions(doc, state):
	...
	if send_email_alert(workflow) and dontmanage.db.get_value(
...
def get_common_email_args(doc):
	...
	lang = doc.get("language") or (
		dontmanage.get_cached_value("Print Format", print_format, "default_print_language")
		if print_format
		else None
	)

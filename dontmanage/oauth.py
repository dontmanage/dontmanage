...
class OAuthWebRequestValidator(RequestValidator):
	...
	def validate_client_id(self, client_id, request, *args, **kwargs):
		...
		if cli_id:
			request.client = dontmanage.get_doc("OAuth Client", client_id).as_dict()
			return True
		else:
			return False
	...
	def validate_redirect_uri(self, client_id, redirect_uri, request, *args, **kwargs):
		...
		redirect_uris = dontmanage.db.get_value("OAuth Client", client_id, "redirect_uris").split(
			get_url_delimiter()
		)
		...
		if code in checkcodes:
			...
			if code_challenge and not request.code_verifier:
				if dontmanage.db.exists("OAuth Authorization Code", code):
					dontmanage.delete_doc("OAuth Authorization Code", code, ignore_permissions=True)
					dontmanage.db.commit()
				return False

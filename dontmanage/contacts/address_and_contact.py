...
def load_address_and_contact(doc, key=None) -> None:
	...
	from dontmanage.contacts.doctype.address.address import get_address_display_list
	from dontmanage.contacts.doctype.contact.contact import get_contact_display_list

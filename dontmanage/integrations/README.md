...
DontManage Framework uses [`oauthlib`](https://github.com/oauthlib/oauthlib) to manage OAuth2 requirements. A DontManage instance can function as all of these:
...
2. **Authorization Server**
   - **OAuth Client**: keeps records of _clients_ registered with the dontmanage instance.
...
3. **Client**
   - **Connected App**: keeps records of _authorization servers_ against whom this dontmanage instance is registered as a _client_ so some resource can be accessed. Eg. a users Google Drive account.
   - **Social Key Login**: similar to **Connected App**, but for the purpose of logging into the dontmanage instance. Eg. a users Google account to enable "Login with Google".
   - **Token Cache**: tokens received by the DontManage instance when accessing a **Connected App**.
...
1. [How to setup OAuth 2?](https://docs.dontmanage.io/framework/user/en/guides/integration/how_to_set_up_oauth)
2. [OAuth 2](https://docs.dontmanage.io/framework/user/en/guides/integration/rest_api/oauth-2)
3. [Token Based Authentication](https://docs.dontmanage.io/framework/user/en/guides/integration/rest_api/token_based_authentication)
4. [Using DontManage as OAuth Service](https://docs.dontmanage.io/framework/user/en/using_dontmanage_as_oauth_service)
5. [Social Login Key](https://docs.dontmanage.io/framework/user/en/guides/integration/social_login_key)
6. [Connected App](https://docs.dontmanage.io/framework/user/en/guides/app-development/connected-app)

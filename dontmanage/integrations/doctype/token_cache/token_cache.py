...
from dontmanage.utils import cint, cstr, get_system_timezone
...
class TokenCache(Document):
	...
	def get_auth_header(self):
		...
		raise dontmanage.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			dontmanage.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
	...
	def get_expires_in(self):
		...
		modified = dontmanage.utils.get_datetime(self.modified)

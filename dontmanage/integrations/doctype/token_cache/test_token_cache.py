...
class TestTokenCache(DontManageTestCase):
	def setUp(self):
		self.token_cache = dontmanage.get_last_doc("Token Cache")
		self.token_cache.update({"connected_app": dontmanage.get_last_doc("Connected App").name})

...
class SocialLoginKey(Document):
	...
	def get_social_login_provider(self, provider, initialize=False):
		...
		providers["GitHub"] = {
			...
			"redirect_url": "/api/method/dontmanage.www.login.login_via_github",
			"api_endpoint": "user",
			"api_endpoint_args": None,
		...
		providers["Google"] = {
			...
			"redirect_url": "/api/method/dontmanage.www.login.login_via_google",
		...
		providers["Facebook"] = {
			...
			"redirect_url": "/api/method/dontmanage.www.login.login_via_facebook",
		...
		providers["DontManage"] = {
			...
			"redirect_url": "/api/method/dontmanage.www.login.login_via_dontmanage",

...
class TelemetryManager {
	constructor() {
		this.enabled = dontmanage.boot.enable_telemetry || false;
		this.posthog_available = Boolean(dontmanage.boot.telemetry_provider?.includes("posthog"));
		this.pulse_available = Boolean(dontmanage.boot.telemetry_provider?.includes("pulse"));

...
dontmanage.scrub = dontmanage.slug = function (text, spacer = "_") {
...
dontmanage.get_data_pill = (
	...
	let color = "",
		style = "";
	if (colored) {
		color = dontmanage.get_palette(label);
	...
	if (remove_action) {
		let remove_btn = $(`
			<span class="remove-btn cursor-pointer">
				${dontmanage.utils.icon("close", "sm", "es-icon")}
			</span>
		`);

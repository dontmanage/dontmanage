...
dontmanage.views.ListGroupBy = class ListGroupBy {
	constructor(opts) {
		$.extend(this, opts);
		this.make_wrapper();
	...
	render_group_by_items() {
		let get_item_html = (fieldname) => {
			...
			if (fieldname === "assigned_to") {
				...
				label = dontmanage.meta.get_label(this.doctype, fieldname);
				let docfield = dontmanage.meta.get_docfield(this.doctype, fieldname);
				if (!docfield) {
					return;
				}

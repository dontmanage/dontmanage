dontmanage.views.TranslationManager = class TranslationManager {
	constructor(opts) {
	...
	get_translations_data() {
		return dontmanage.db.get_list("Translation", {
	...
	update_translations({ source, translation_data = [] }) {
		...
		return dontmanage
			.call({
				method: "dontmanage.translate.update_translations_for_source",

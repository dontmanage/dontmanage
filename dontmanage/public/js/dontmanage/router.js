...
$(window).on("hashchange", function (e) {
	...
	if (window.location.hash && !dontmanage.router.is_app_route(e.currentTarget.pathname)) {
		let sub_path = dontmanage.router.get_sub_path(window.location.hash);
		dontmanage.router.push_state(sub_path);
		return false;
	}
});

	...
	<div>
		<div class="row form-section visible-section shaded-section">
			<div class="section-body">
				<div class="form-column col-sm-12">
					<form>
						<div class="dontmanage-control" :data-fieldtype="column.type" v-for="(column, index) in columns" :key="index" :class="column.class">
		...
		<div class="row form-section visible-section">
			...
			<div class="section-body">
				<div class="form-column col-sm-12">
					<form>
						<div class="form-group dontmanage-control input-max-width" data-fieldtype="Check">
							<div class="checkbox">
								<label>
						...
						<div class="dontmanage-control" data-fieldtype="Table">
							<div>
								<div class="form-grid">
																		...
																		<div class="section-body">
																			<div class="form-column col-sm-12">
																				<form>
																					...
																					<div class="dontmanage-control input-max-width">
																						<div class="form-group">
																					...
																					<div class="dontmanage-control" v-if="call.explain_result[0]">
																						<div class="form-group">
...
export default {
	...
	mounted() {
		...
		if (request.headers || request.form_dict || request.calls) {
			...
			dontmanage.call({
				method: "dontmanage.recorder.get",
				args: {
					uuid: request.uuid
				}
			}).then( r => {

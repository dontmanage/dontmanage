...
dontmanage.provide("dontmanage.widget");

dontmanage.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
dontmanage.widget.make_widget = (opts) => {
	const widget_class = dontmanage.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = dontmanage.widget.make_widget({
			...widget,
...
dontmanage.widget.WidgetGroup = WidgetGroup;
dontmanage.widget.SingleWidgetGroup = SingleWidgetGroup;

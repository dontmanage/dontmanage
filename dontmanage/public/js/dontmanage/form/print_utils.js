dontmanage.ui.get_print_settings = function (
	pdf,
	callback,
	letter_head,
	pick_columns,
	...
	var company = dontmanage.defaults.get_default("company");
		...
		},
		{
			...
			get_query: () => ({
				filters: {
					...
					report: dontmanage.query_report ? dontmanage.query_report.report_name : "",
					disabled: 0,
				},
			}),
		},
		...
		function (settings) {
			...
			if (!settings.with_letter_head) {
				...
				if (letter_head_name) {
					...
					settings.letter_head = dontmanage.boot.letter_heads[letter_head_name];
				}
			}

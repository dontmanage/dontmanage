export default class GridRowForm {
	...
	render() {
		...
		dontmanage.utils.scroll_to(0, false, 0, this.wrapper.find(".grid-form-body"));
				...
				<div class="toolbar grid-header-toolbar">
					...
					<span class="row-actions">
						...
						<button class="btn btn-secondary btn-sm pull-right grid-duplicate-row hidden-xs">
							${dontmanage.utils.icon("duplicate")}
							${__("Duplicate")}
						</button>
						...
						<button class="btn btn-danger btn-sm pull-right grid-delete-row">
							${dontmanage.utils.icon("trash-2")} ${__("Delete")}
						</button>
					</span>
				</div>
			</div>
			<div class="grid-form-body">
				...
				<div class="grid-footer-toolbar hidden-xs flex justify-between">
					<div class="grid-shortcuts">
						<span> ${dontmanage.utils.icon("keyboard", "md")} </span>
	...
	set_active_tab(tab) {
		...
		// This is similar to the fix in dontmanage/dontmanage#27441 for regular forms
		let in_tab = false;

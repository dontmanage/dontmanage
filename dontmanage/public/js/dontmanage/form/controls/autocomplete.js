...
dontmanage.ui.form.ControlAutocomplete = class ControlAutoComplete extends dontmanage.ui.form.ControlData {
	...
	parse_options(options) {
		if (typeof options === "string" && options[0] === "[") {
			options = dontmanage.utils.parse_json(options);
		}
	...
	async load_installed_apps(frm) {
		...
		await dontmanage.call({
			method: "dontmanage.desk.desktop.get_installed_apps",
			callback: function (r) {
				if (r.message) {

dontmanage.ui.form.ControlButton = class ControlButton extends dontmanage.ui.form.ControlData {
	can_write() {
	...
	make_input() {
		...
		this.$input = $(
			`<button
				class="btn ${dontmanage.utils.escape_html(btn_size)} ${dontmanage.utils.escape_html(btn_type)}"
				title="${dontmanage.utils.escape_html(this.df.label)}"
			>`
		)

dontmanage.ui.form.ControlMarkdownEditor = class ControlMarkdownEditor extends (
	dontmanage.ui.form.ControlCode
) {
	...
	update_preview() {
		...
		this.markdown_preview.html(dontmanage.markdown(value));
	}

dontmanage.ui.form.ControlSignature = class ControlSignature extends dontmanage.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		dontmanage.require("/assets/dontmanage/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${dontmanage.utils.icon("restriction", "md")}</i>

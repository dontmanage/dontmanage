dontmanage.ui.form.ControlSelect = class ControlSelect extends dontmanage.ui.form.ControlData {
	...
	set_options(value) {
		...
		if (this.$input) {
			...
			this.$input.empty();
			dontmanage.ui.form.add_options(this.$input, options || []);
...
dontmanage.ui.form.add_options = function (input, options_list) {
	let $select = $(input);
...
(function ($) {
	$.fn.add_options = function (options_list) {
		return dontmanage.ui.form.add_options(this.get(0), options_list);
	};

...
dontmanage.ui.form.QuickEntryForm = class QuickEntryForm extends dontmanage.ui.Dialog {
	...
	render_dialog() {
		...
		this.onhide = () => (dontmanage.quick_entry = null);
	...
	handle_after_callbacks() {
		...
		if (dontmanage._from_link) {
			dontmanage.ui.form.update_calling_link(this.doc);
			...
			dontmanage.call({
				...
				callback: function (r) {
					if (
						...
						dontmanage.model.can_submit(me.doctype) &&
						!dontmanage.model.has_workflow(me.doctype)
					) {

...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			dontmanage.model.clear_doc("Print Format", print_format_name);
			dontmanage.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = dontmanage.get_doc("Print Format", print_format_name);
				dontmanage.model.with_doctype(_print_format.doc_type, () => {
					meta.value = dontmanage.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return dontmanage.db.get_doc("Letter Head", _letterhead).then((doc) => {

		...
		methods: {
			fetch() {
				return new Promise((resolve) => {
					dontmanage.model.clear_doc("Print Format", this.print_format_name);
					dontmanage.model.with_doc("Print Format", this.print_format_name, () => {
						let print_format = dontmanage.get_doc("Print Format", this.print_format_name);
						dontmanage.model.with_doctype(print_format.doc_type, () => {
							this.meta = dontmanage.get_meta(print_format.doc_type);
			...
			change_letterhead(letterhead) {
				return dontmanage.db.get_doc("Letter Head", letterhead).then((doc) => {
					this.letterhead = doc;
				});
			},
		},

...
to provide custom formatting and logging for test results in the DontManage framework.
...
test results during test execution in the DontManage framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from dontmanage.deprecation_dumpster import DontManageDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=DontManageDeprecationWarning)
...
class DontManageTestResult(unittest.TextTestResult):
	def __init__(self, stream, descriptions, verbosity):
		super().__init__(stream, descriptions, verbosity)

"""
This module contains the TestRunner class, which is responsible for executing test suites in DontManage.
...
- Integration with DontManage's configuration and environment setup
...
Usage:
The TestRunner is typically instantiated and used by DontManage's test discovery and execution system.
...
class TestRunner(unittest.TextTestRunner):
	...
	def _prepare_category(self, category, suite, app):
		from dontmanage.deprecation_dumpster import get_compat_dontmanage_test_case_preparation

		dispatcher = {
			"integration": self.integration_preparation,
			"old-dontmanage-test-class-category": get_compat_dontmanage_test_case_preparation(self.cfg),

...
This module provides a comprehensive framework for running tests in DontManage applications. It includes functionality for test discovery, execution, result reporting, and environment setup.
...
This module is typically used by DontManage's CLI commands for running tests, but can also be used programmatically for custom test execution scenarios.

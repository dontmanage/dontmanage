...
import dontmanage
from dontmanage.utils import cstr, get_site_name
from dontmanage.utils.response import FORCE_DOWNLOAD_EXTENSIONS
...
class StaticDataMiddleware(SharedDataMiddleware):
	...
	def get_directory_loader(self, directory):
		def loader(path):
			site = get_site_name(dontmanage.app._site or self.environ.get("HTTP_HOST"))

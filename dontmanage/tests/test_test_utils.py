...
class TestTestUtils(IntegrationTestCase):
	...
	def test_temp_setting_changes(self):
		...
		with IntegrationTestCase.change_settings(
			...
			updated_settings = dontmanage.get_single_value("System Settings", "logout_on_password_reset")
			self.assertNotEqual(current_setting, updated_settings)

		restored_settings = dontmanage.get_single_value("System Settings", "logout_on_password_reset")

...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for DontManage tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to DontManage framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = dontmanage.get_module(cls.__module__)
		# Test Environment
		dontmanage.set_user("Administrator")
		# Test Environment (cleanup)
		cls.addClassCleanup(dontmanage.set_user, "Administrator")
...
def _get_doctype_from_module(cls):
	...
	path = dontmanage.get_pymodule_path(cls.__module__)
	try:

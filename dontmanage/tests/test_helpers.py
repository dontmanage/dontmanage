...
def create_test_blog_post():
	test_blog_doc = dontmanage.get_doc(
		{
			"doctype": "DocType",
			"name": "Test Blog Post",
...
def create_test_blog_records():
	...
	for r in test_blog_records:
		dontmanage.get_doc(r).insert(ignore_if_duplicate=True, ignore_links=True)
...
def setup_for_tests():
	...
	dontmanage.delete_doc_if_exists("DocType", "Test Blog Post")
	dontmanage.delete_doc_if_exists("DocType", "Test Blog Category")
	dontmanage.delete_doc_if_exists("DocType", "Test Blogger")

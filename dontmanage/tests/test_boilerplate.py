...
import dontmanage
from dontmanage.modules.patch_handler import get_all_patches, parse_as_configfile
from dontmanage.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = dontmanage._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.default_user_input = dontmanage._dict(
			{
				"title": "Test App",
		...
		cls.bench_path = dontmanage.utils.get_bench_path()
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(dontmanage.get_app_path("dontmanage", "patches.txt")))
		...
		expected_patch = "dontmanage.core.doctype.user.patches.delete_all_users"

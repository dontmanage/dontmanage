...
from dontmanage.utils import format_date, today
from dontmanage.utils.goal import get_monthly_goal_graph_data, get_monthly_results
...
class TestGoal(IntegrationTestCase):
	...
	def test_get_monthly_goal_graph_data(self):
		...
		docname = dontmanage.get_list("Event", filters={"subject": ["=", "_Test Event 1"]})[0]["name"]
		dontmanage.db.set_value("Event", docname, "description", 1)

...
from dontmanage.model.base_document import BaseDocument, _get_extended_class
...
class TestBaseDocument(IntegrationTestCase):
	...
	def test_get_extended_class_with_extensions(self):
		...
		# Mock dontmanage.get_hooks to return extension paths
		extensions = [
			"dontmanage.tests.test_base_document.TestExtensionA",
			"dontmanage.tests.test_base_document.TestExtensionB",
		]
	...
	def test_extension_overrides_todo_method(self):
		...
		extensions = ["dontmanage.tests.test_base_document.TestToDoExtension"]
	...
	def test_extension_invalid_path_raises_exception(self):
		...
		extensions = [
			"dontmanage.tests.test_base_document.TestExtensionA",  # valid
...
def clear_todo_controller_cache():
	...
	if hasattr(dontmanage, "controllers") and dontmanage.local.site in dontmanage.controllers:
		dontmanage.controllers[dontmanage.local.site].pop("ToDo", None)

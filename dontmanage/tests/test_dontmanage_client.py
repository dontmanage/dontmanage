...
from dontmanage.model import default_fields
from dontmanage.tests import IntegrationTestCase
from dontmanage.utils.data import get_url


class TestDontManageClient(IntegrationTestCase):
	...
	def test_list_summary(self):
		...
		getall_users = dontmanage.db.get_all(
			"User",
	...
	def test_get_single(self):
		...
		dontmanage.db.rollback()  # Clear snapshot isolation
		dontmanage.db.set_single_value("Website Settings", "title_prefix", "")
	...
	def test_delete_doc(self):
		...
		self.assertFalse(dontmanage.db.get_value("Note", NAME_TO_DELETE))

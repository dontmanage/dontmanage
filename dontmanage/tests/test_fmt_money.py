...
from dontmanage.utils import fmt_money


class TestFmtMoney(DontManageTestCase):
	def test_standard(self):
		dontmanage.db.set_default("number_format", "#,###.##")
	...
	def test_currency_precision(self):
		dontmanage.db.set_default("currency_precision", "4")
		dontmanage.db.set_default("number_format", "#,###.##")
		self.assertEqual(fmt_money(100), "100.00")
		self.assertEqual(fmt_money(1000), "1,000.00")
		self.assertEqual(fmt_money(10000), "10,000.00")
		...
		dontmanage.db.set_default("currency_precision", "")
	...
	def test_fmt_with_symbol_pos(self):
		dontmanage.db.set_value("Currency", "JPY", "symbol_on_right", 1)
